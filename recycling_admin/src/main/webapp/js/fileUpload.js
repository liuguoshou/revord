...
function ajaxFileUploadx(fileid,type,imgid,inputid,isCompress) {
	loading();// 动态加载小图标
	
	
	$.ajaxFileUpload({
		
		url : contextPath+'/common/fileUpload.do?type='+type+"&isCompress="+isCompress+"&d="+new Date().getTime(),
		secureuri : false,
	...
	$("#"+fileid).attr('onchange',"changeFile('"+fileid+"')");
	return false;
}
function loading() {
